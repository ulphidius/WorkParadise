function verifFormUserAdd(){
	...
	if(errors > 0){
		...
		xhr.open("POST", "requestAdminUsersAdd.php", true);
		xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xhr.send("firstname=" + firstname.value + "&lastname=" + lastname.value + "&email=" + email.value + "&pwd=" + pwd.value + "&phone=" + phone.value + "&statut=" + statut.value + "&secret=" + secret.value);
