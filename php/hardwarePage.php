					...
					<div class="row">
						...
						<form class="form" id="form_"> <!-- form with site, room, dateStart, dateEnd -->
								...
								<div class="form-group">
									...
									<select id="1" name="hardwareType" class="form-control">
									<!--we get  sites in conf.php  -->
									<?php
										$hardwareDefault = (isset($dataForm["hardwareType"]))?$dataForm["hardwareType"]:"ordi_bureau";

										foreach ($listOfHardware as $key => $hardware) {
										echo '<option value="'.$key.'"';
										echo ($hardwareDefault == $key)?'selected="selected"':'';
										echo' >'.$hardware.'</option>';
										}
									?>
...
<script src="../js/hardwareCommand.js"></script>
