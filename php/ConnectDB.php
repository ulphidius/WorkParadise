	...
	class ConnectDB{
		...
		public function connectToDB(){
			try{
				...
				/*echo("Le host : ".$this->_hostName." le nom de la base de données : ".$this->_dbName." le type d'encodage : ".$this->_charset." le nom de l'utilisateur : ".$this->_userName." le mot de passe : ".$this->_pwd);*/
