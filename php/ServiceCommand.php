<?php
	...
	class serviceCommand{
		...
		public function __destruct(){
			unset($this->_idService);
			unset($this->_serviceType);
		...
		public function __toString(){
			return " le prix est : ".$this->_price."  l'id : ".$this->_id."  le serviceType est : ".$this->_serviceType."  l'id service est : ".$this->_idService." information : ".$this->_information." status : ".$this->_status." et la quantité : ".$this->_quantity." dateStart : ".$this->_dateStart." dateEnd : ".$this->_dateEnd;
		}
